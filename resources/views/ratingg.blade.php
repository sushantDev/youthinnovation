...
<div class="container">
    ...
    <img src="{{asset('images/event2.jpg')}}" width="815px">
        ...
        <div class="wrapper">
                <label for="rad" style="color: black">Innovation</label>
                <input type="radio" id="rad" name="rad1" value="1" style="margin-left: 29px">
                <input type="radio" id="rad2" name="rad1" value="2">
                <input type="radio" id="rad3" name="rad1" value="3">
                <input type="radio" id="rad4" name="rad1" value="4">
                <input type="radio" id="rad5" name="rad1" value="5">
        </div>

        <div class="wrapper">
            <label for="rad" style="color: black">Impact</label>
            ...
            <div class="wrapper">
            <label for="rad" style="color: black">Sustainability</label>
        ...
        <button type="submit" style="margin-left: 80px; margin-top: 34px; color: black">Rate Now</button>
    {{ Form::close() }}

    <div class="clearfix">
        <div id="redBecomesBlue" class="red big"></div>
            <a href="javascript:void(0);" id="changeCircle0"></a>
            <a href="javascript:void(0);" id="changeCircle1"></a>
            <a href="javascript:void(0);" id="changeCircle2"></a>
            <a href="javascript:void(0);" id="changeCircle3"></a>
            <a href="javascript:void(0);" id="changeCircle4"></a>
