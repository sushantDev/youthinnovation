...
{{--                        <td>{{ str_limit($user->username, 47) }}</td>--}}
                        ...
                        <td class="text-right">
                            <a href="{{route('user.show', $user->slug)}}" class="btn btn-flat btn-primary btn-xs">
                                View
                            </a>
                            <a href="{{route('user.edit', $user->slug)}}" class="btn btn-flat btn-primary btn-xs">
                                Edit
                            </a>
                            <button type="button" data-url="{{ route('user.destroy', $user->slug) }}" class="btn btn-flat btn-primary btn-xs item-delete">
                                Delete
                            </button>
                        </td>
                    </tr>
