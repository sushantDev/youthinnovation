        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {{ Form::text('quote',old('quote'),['class'=>'form-control', 'required']) }}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {{ Form::text('author',old('author'),['class'=>'form-control', 'rows'=>2]) }}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {{ Form::textarea('type',old('type'),['class'=>'form-control', 'rows'=>2]) }}
        ...
        <div class="card card-affix affix-4">
            ...
            <div class="card-actionbar">
                <div class="card-actionbar-row">
                    <button type="reset" class="btn btn-default ink-reaction">Reset</button>
                    <input type="submit" name="draft" class="btn btn-info ink-reaction" value="Save Draft">
                    <input type="submit" name="publish" class="btn btn-primary ink-reaction" value="{{ isset($news) && $news->is_published ? 'Save' : 'Publish' }}">
                </div>
            </div>
        </div>
    </div>
