        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {{ Form::text('venue',old('venue'),['class'=>'form-control', 'required']) }}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {{ Form::date('date',old('date'),['class'=>'form-control', 'rows'=>2]) }}
        ...
        <div class="card card-affix affix-4">
                    ...
                    <div class="col-xs-6 col-sm-12">
                        <div class="checkbox checkbox-styled">
                            <label>
                                ...
                                <span>Feature this Event in Home Page</span>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-actionbar">
                <div class="card-actionbar-row">
                    <button type="reset" class="btn btn-default ink-reaction">Reset</button>
                    <input type="submit" name="draft" class="btn btn-info ink-reaction" value="Save Draft">
                    <input type="submit" name="publish" class="btn btn-primary ink-reaction" value="{{ isset($event) && $event->is_published ? 'Save' : 'Publish' }}">
                </div>
            </div>
        </div>
    </div>
