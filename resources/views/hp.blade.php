...
<div class="section white" id="first" data-parallax="scroll" data-image-src="{{asset('images/circle.png')}}">
    <div class="text">
    ...
    {{--<div class="f-register__title">--}}
    {{--<h2>Youth Innovation Challenge</h2>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--</div>--}}
    ...
    <div class="section_i">
        ...
        <div class="about clearfix">
            <div class="about__text">
                ...
                {{--<a href="#more-text" class="btn btn_black popup-btn">read more</a>--}}
                {{--<a href="#nine" class="btn btn_pink scroll-link ">REGISTER</a>--}}
                {{--</div>--}}
            </div>
                                                                ...
                                                                <div class="try">
                                                                    <ul>
                                                                        <label for="s1" class="hult-slider-nav-item">
                                                                            <img src="{{asset('wp-content/uploads/2017/03/problem.png')}}"
                                                                                 class="img img-active" alt="Ignite" style="margin-top: -45px; margin-left: 432px;"/>
                                                                            <img src="{{asset('wp-content/uploads/2017/03/problem-black.png')}}"
                                                                        ...
                                                                        <label for="s2" class="hult-slider-nav-item"
                                                                            ...
                                                                            <img src="{{asset('wp-content/uploads/2017/03/solution.png')}}"
                                                                                 class="img img-active" alt="Educate" style="margin-top:-314px; margin-left: 676px"/><img
                                                                                    src="{{asset('wp-content/uploads/2017/03/solution_grey.png')}}"
                                                                                    class="img" alt="Educate" style="margin-top:-314px; margin-left: 676px"/>
                                                                            {{--<span class="text">Our Solution<br></span>--}}
                                                                        </label>
                                                                        <label for="s5" class="hult-slider-nav-item"
                                                                               style="margin-top: 264px;margin-left: -150px;">
                                                                            <img src="{{asset('wp-content/uploads/2017/03/status.png')}}"

                                                                                 class="img img-active" alt="Compete" style="margin-left:1466px; margin-top: -565px;"/><img
                                                                            <img src="{{asset('wp-content/uploads/2017/03/status-grey.png')}}"
                                                                                 class="img" alt="Compete" style="margin-left:1466px; margin-top: -565px;"/>
                                                                        ...
                                                                        <label for="s4" class="hult-slider-nav-item"
                                                                            ...
                                                                            <img src="{{asset('wp-content/uploads/2017/03/status.png')}}"
                                                                                 ...
                                                                                 alt="Accelerate" style="margin-left: 1190px; margin-top: -838px;"/><img src="{{asset('wp-content/uploads/2017/03/status-grey.png')}}"
                                                                                                                                                         class="img" alt="Accelerate" style="margin-left: 1190px; margin-top: -838px;"/>
                                                                            {{--<span class="text">Current Status</span>--}}
                                                                        </label>
                                                                        <label for="s3" class="hult-slider-nav-item"
                                                                               style="margin-top: 401px;margin-left: -150px;">
                                                                            <img src="{{asset('wp-content/uploads/2017/03/impact.png')}}"
                                                                                 class="img img-active"
                                                                                 alt="Accelerate" style="margin-left: 920px; margin-top: -838px;"/>
                                                                            <img  src="{{asset('wp-content/uploads/2017/03/impact_grey.png')}}"
                                                                                  class="img" alt="Accelerate" style="margin-left: 920px; margin-top: -838px;"/>
                                                                            <span class="text">Current Status</span>
                                                                        </label>
                                                                    </ul>
                                                                </div>
