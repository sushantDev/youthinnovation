(function(a){
	0a.fn.rateCircle=function(k)
	{var f=a.extend({size:100,lineWidth:10,fontSize:30,referenceValue:100,valuePrefix:"",valueSufix:"",},k);
	var i=f.size,
	c=i/2,
	b=c-f.lineWidth/2,
	j=f.lineWidth,
