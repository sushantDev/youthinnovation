...
!function () {
    ...
    jQuery.extend(!0, t, {
        resetVideo: function (t) {
            ...
            var i = a.find("iframe, video"), o = e.split(":")[0], d = e.split(":")[1], n = t.width / t.height,
                r = o / d, s = n / r * 100, p = r / n * 100;
            ...
            var s = o.data("videoattributes"), p = o.data("ytid"), l = o.data("vimeoid"), v = o.data("videpreload"),
                u = o.data("videomp4"), c = o.data("videowebm"), f = o.data("videoogv"),
                m = o.data("allowfullscreenvideo"), h = o.data("videocontrols"), g = "http",
    ...
    var i = function (e, t, a) {
        ...
        var p = i.find("iframe"), l = "iframe" + Math.round(1e5 * Math.random() + 1), v = i.data("videoloop"),
                ...
                var f = new YT.Player(l, {
                    events: {
                        onStateChange: function (t) {
                            var a = t.target.getVideoEmbedCode(), i = jQuery("#" + a.split('id="')[1].split('"')[0]),
                                n = i.closest(".tp-simpleresponsive"), p = i.parent(), l = i.parent().data("player");
                        ...
                        }, onReady: function (t) {
                            {
                                var i = t.target.getVideoEmbedCode(),
                                    o = jQuery("#" + i.split('id="')[1].split('"')[0]), d = o.parent(),
                                    n = d.data("videorate");
                                d.data("videostart")
                            }
        ...
        var m = d.find(".tp-vid-play-pause")[0], h = d.find(".tp-vid-mute")[0], g = d.find(".tp-vid-full-screen")[0],
            y = d.find(".tp-seek-bar")[0], w = d.find(".tp-volume-bar")[0];
