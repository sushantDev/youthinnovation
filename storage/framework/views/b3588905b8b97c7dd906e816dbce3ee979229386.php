        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <?php echo e(Form::text('facts',old('learn'),['class'=>'form-control', 'required'])); ?>

                            <?php echo e(Form::label('facts','Facts*')); ?>
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <?php echo e(Form::text('data',old('learn'),['class'=>'form-control', 'required'])); ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <?php echo e(Form::text('spirit',old('learn'),['class'=>'form-control', 'required'])); ?>

                            <?php echo e(Form::label('spirit','Spirit*')); ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <?php echo e(Form::text('strategy',old('learn'),['class'=>'form-control', 'required'])); ?>

                            <?php echo e(Form::label('strategy','Strategy*')); ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <?php echo e(Form::text('advocacy',old('learn'),['class'=>'form-control', 'required'])); ?>

                            <?php echo e(Form::label('advocacy','Advocacy*')); ?>
