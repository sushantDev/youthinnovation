                        ...
                        <div class="tabbar">
                            <div class="tabs-wrapper">
                                <ul class="tabs_paging">
                                    <li></li>
                                    <li><a href="<?php echo e(url('mission')); ?>" title="Recognizing talent with an awards program?"><span><br><br>Our Mission</span></a></li>
                                    <li><a href="<?php echo e(url('how')); ?>"  title="Recognizing talent with an awards program?"><span><br><br>How we work?</span></a></li>
                                    <li class="active"><a href="<?php echo e(url('what')); ?>" title="Creatively market your event?"><span><br><br>What we do?</span></a></li>
        ...
        <section class="tabs_content">
            <div class="tab">
                <div class="secondary_intro with_banner">
                 <?php $__currentLoopData = $what_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="content_box">
                      ...
                      <div class="row" style="width: 1400px">
                            ...
                            <div class="col-md-2">
                      <img src="<?php echo e(asset('images/what4.png')); ?>" width="140px" style="margin-left: -10px;">
                    <div class="span">Facts & Research</div>
                      
                      <?php $__currentLoopData = $what_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($data->facts): ?>
                      <br><p style="color: #606060;margin-top: 40px;font-size: 16px;">
                            <?php echo e($data->facts); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <div class="col-md-2">
                          <img src="<?php echo e(asset('images/what3.png')); ?>" width="140px" style="margin-left: -10px;">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-md-2">
                                <img src="<?php echo e(asset('images/what2.png')); ?>" width="140px" style="margin-left: -10px;">

                              <div class="span">Spirit of Volunteerism</div>
                              <?php $__currentLoopData = $what_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($data->spirit): ?>
                                <br><p style="color: #606060;margin-top:10px;font-size: 16px;"> <?php echo e($data->spirit); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-md-2">
                                <img src="<?php echo e(asset('images/what5.png')); ?>" width="140px" style="margin-left: -10px;">

                              <div class="span">Strategic Innovation</div>
                               <?php $__currentLoopData = $what_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($data->strategy): ?>
<br><p style="color: #606060;font-size: 16px;margin-top: 42px;"><?php echo e($data->strategy); ?></p>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-md-2">
                                <img src="<?php echo e(asset('images/what1.png')); ?>" width="140px" style="margin-left: -10px;">

                              <div class="span">Advocacy</div>
                              <?php $__currentLoopData = $what_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($data->advocacy): ?>
                                <p style="color: #606060; margin-top: 68px;font-size: 16px;"> <?php echo e($data->advocacy); ?>
...
<div class="foot">
    <img src="<?php echo e(asset('images/whatimage.png')); ?>">
